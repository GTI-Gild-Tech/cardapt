import svgPaths from "./svg-itpyg0wv3m";
...
function Frame156() {
  return (
    <div
      className="absolute bg-[rgba(255,255,255,0.59)] h-[114px] rounded-[10px] top-[127px] translate-x-[-50%] w-[552px]"
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[9px] items-start justify-start p-0 relative shrink-0">
      <div className="font-['Rethink_Sans:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#ffffff] text-[24px] text-left text-nowrap tracking-[-0.494px]">
        <p className="adjustLetterSpacing block leading-[26px] whitespace-pre">Continuar pedido</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[35px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 35">
        <g id="Frame">
          <path d={svgPaths.p1becc900} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame4782() {
  return (
    <div className="absolute bg-primary box-border content-stretch flex flex-row h-[83px] items-center justify-between left-0 px-[25px] py-[13px] rounded-[43px] top-[880px] w-[539px]">
      <Frame4776 />
      <Frame157 />
    </div>
  );
...
function Group4852() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] font-['Rethink_Sans:ExtraBold',_sans-serif] font-extrabold ml-0 mt-0 relative text-textColorPrimary text-[42px] text-left tracking-[0.396px] w-[343px]">
        <p className="adjustLetterSpacing block leading-[41px]">Meu pedido</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-8" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Frame">
          <path d={svgPaths.p1d21dc0} fill="var(--fill-0, #7F1010)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function Frame4786() {
  return (
