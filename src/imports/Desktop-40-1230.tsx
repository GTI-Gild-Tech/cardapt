...
function Ticket() {
  return (
    <div className="bg-tertiary box-border content-stretch flex flex-col gap-2 items-start justify-start px-[15px] py-5 relative rounded-[8px] shadow-[0px_4px_8px_0px_rgba(0,0,0,0.12),0px_16px_32px_0px_rgba(0,0,0,0.08)] shrink-0 w-80" data-name="ticket">
      <Frame4858 />
      <Frame4872 />
    </div>
  );
