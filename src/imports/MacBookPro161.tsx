...
function Navbar() {
  return (
    <div
      className="absolute bg-secondary box-border content-stretch flex flex-row gap-5 items-start justify-start left-1/2 px-[200px] py-10 rounded-bl-[50px] rounded-br-[50px] top-0 translate-x-[-50%]"
      data-name="Navbar"
    >
      <Frame />
      <Frame1 />
